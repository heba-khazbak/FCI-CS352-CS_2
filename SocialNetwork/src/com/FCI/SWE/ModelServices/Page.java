...
public class PostFilter {
	...
	/**
	 * Filter.
	 * This static method filters the post's content by extracting hashtags from it
	 * and then saving them in Hashtag Table
	 *
	...
	/**
	 * Format post.
	 * This static method takes a Post object and formats it into a string depending
	 * on the post's type and then adds some HTML tags to it to make it easier to be
	 * printed on multiple JSP pages.
	 * 
	 *
	 * @param post the post
