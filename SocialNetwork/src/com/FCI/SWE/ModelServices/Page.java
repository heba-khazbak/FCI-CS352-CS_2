...
public class Page {
	...
	/**
	 * 
	 * This method will save a new page using page data if the page name doesn't
	 * exist from before
	 */
	...
	public static Page getPage(String pageID) {
		...
		for (Entity entity : pq.asIterable()) {
			if (entity.getProperty("name").toString().equals(pageID)) {
				...
				int likes = Integer.parseInt(entity
						.getProperty("numberOfLikes").toString());
	...
	/**
	 * 
	 * This static method will tell if a specific page exists or not using it's
	 * name
	 * 
	 * @param pageName
	 ...
	 * 
	 * @return Vector of page entity containing all pages in datasotre
	 */
	public static Vector<Page> getAllPages() {
		...
		for (Entity entity : pq.asIterable()) {
			...
			String pageOwner = entity.getProperty("owner").toString();
			String categ = entity.getProperty("category").toString();
			int likes = Integer.parseInt(entity.getProperty("numberOfLikes")
					.toString());
	...
	/**
	 * 
	 * This static method will tell if a specific user is the owner of the page
	 * or not
	 * 
	 * @param pageName
	 *            String of the name of the selected page
